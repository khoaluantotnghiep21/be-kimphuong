...
export class Sanpham {
  ...
  @OneToMany(() => Chitietdonhang, (chitietdonhang) => chitietdonhang.masanpham2)
  chitietdonhangs: Chitietdonhang[];

  @OneToMany(() => Chitietdonnhap, (chitietdonnhap) => chitietdonnhap.masanpham2)
  chitietdonnhaps: Chitietdonnhap[];

  @OneToMany(() => Chitietdonthuoctuvan, (chitietdonthuoctuvan) => chitietdonthuoctuvan.masanpham2)
  ...
  @OneToMany(() => Chitietthanhphan, (chitietthanhphan) => chitietthanhphan.masanpham2)
  chitietthanhphans: Chitietthanhphan[];

  @OneToMany(() => Danhgia, (danhgia) => danhgia.masanpham)
  danhgias: Danhgia[];

  @OneToMany(() => NhathuocSanpham, (nhathuocSanpham) => nhathuocSanpham.masanpham2)
  nhathuocSanphams: NhathuocSanpham[];

  @ManyToOne(() => Chuongtrinhkhuyenmai, (chuongtrinhkhuyenmai) => chuongtrinhkhuyenmai.sanphams)
  @JoinColumn([{ name: 'machuongtrinh', referencedColumnName: 'machuongtrinh' }])
